...
## Load the rubric
# filename_rubric = "grading-rubric.md"
# with open(filename_rubric, "r") as file:
#     str_rubric = file.read()

## Load the checklist
# filename_checklist = "checklist.md"
# with open(filename_checklist, "r") as file:
#     str_checklist = file.read()
